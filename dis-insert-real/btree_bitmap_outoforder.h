...
#define NVRAM_LEN 1 * 1024 * 1024 * 1024 //1G
...
public:
    ...
    { 
		vmp = nv_create("/mnt/nvram1", NVRAM_LEN);
		if(vmp == NULL)
    ...
    */
                                             ...
                                             key_type* splitkey, node** splitnode)
    {
        ...
        else // n->isleafnode() == true
        {
			...
			nv_flush((char *)leaf->bs, BITS_TO_LONGS(leafslotmax));
			//nvbitmap_count++;
    ...
    void split_leaf_node(leaf_node* leaf, key_type* _newkey, node** _newleaf)
    {
		...
		for(int i = 0; i < orig_slotused; i++) {
			vec.push_back(std::make_pair<unsigned long, int>(leaf->slotkey[i], i));
		}
